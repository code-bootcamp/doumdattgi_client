  ...
  return (
    <>
      <S.Wrapper>
        ...
        <S.Contents>
          뚫고 지나가요 - Day6 축 처진 그 어깨에 슬프다 써져 있길래 조심스레
          괜찮냐 물어도 대답은 침묵뿐이에요 힘이 되고 싶어, 뭔 짓을 해 봐도 안
          보이나 봐요, 눈앞에 있는데도 서서히 금이 가 깨질 것 같지만 그래도 난
          ...
          아닌 거니까 그대가 미워, 떠나려 해 봐도 안되더라고요 눈앞에 있으니까
          서서히 금이 가 깨질 걸 알아도 그래도 난 버티고 있었죠 이번만큼은
          예상이 빗나가길 그리도 간절히 원했는데 왜? 그냥 가라는 말 그대의
          한마디가 나를 뚫고 지나가요 더 이상은 걷잡을 수 없이 널 향한 맘 작은
          조각들로 부서지고 흩어져요 여기가 내 사랑의 끝이네요 난 무너져 내리고
          있는 이 순간에도 No, it's not easy to leave for good 그냥 가라는 말
          그대의 한마디가 나를 뚫고 지나가요 더 이상은 걷잡을 수 없이 널 향한 맘
          작은 조각들로 부서지고 흩어져요 여기가 내 사랑의 끝이네요 So I guess
          now I've got to go 이렇게 떠나도 그대는 달라질 거 하나 없죠 Oh, so I
          guess now theres no more us 그대가 필요한 건 내가 아닌 거니까
        </S.Contents>
        <S.PaymentBox>
